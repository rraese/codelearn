export const kotlinLessons = [
    {
        id: 1,
        title: 'Hallo Welt & println',
        description: 'Dein erstes Kotlin-Programm',
        duration: '5 min',
        theory: `
<h2>Hallo Welt & println 🚀</h2>
<p>Dein erstes Kotlin-Programm. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    {
        id: 2,
        title: 'Variablen: val & var',
        description: 'Unveränderliche und veränderliche Werte',
        duration: '8 min',
        theory: `
<h2>Variablen: val & var 📦</h2>
<p>Unveränderliche und veränderliche Werte. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Variablen: val & var – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Variablen: val & var</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    {
        id: 3,
        title: 'Datentypen & Null Safety',
        description: 'Sichere Null-Behandlung mit ?',
        duration: '10 min',
        theory: `
<h2>Datentypen & Null Safety 🔄</h2>
<p>Sichere Null-Behandlung mit ?. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Datentypen & Null Safety – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Datentypen & Null Safety</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    {
        id: 4,
        title: 'If-Bedingungen & when',
        description: 'Kotlins elegante Verzweigung',
        duration: '8 min',
        theory: `
<h2>If-Bedingungen & when 🔀</h2>
<p>Kotlins elegante Verzweigung. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// If-Bedingungen & when – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von If-Bedingungen & when</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    {
        id: 5,
        title: 'Schleifen & Ranges',
        description: 'for und while mit Ranges',
        duration: '8 min',
        theory: `
<h2>Schleifen & Ranges 🔧</h2>
<p>for und while mit Ranges. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Schleifen & Ranges – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Schleifen & Ranges</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 6,
        title: 'Funktionen',
        description: 'Top-Level und Extension Functions',
        duration: '10 min',
        theory: `
<h2>Funktionen 📋</h2>
<p>Top-Level und Extension Functions. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 7,
        title: 'Collections',
        description: 'List, Set und Map',
        duration: '10 min',
        theory: `
<h2>Collections 🏗️</h2>
<p>List, Set und Map. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Collections – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Collections</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        ...
        description: 'Anonyme Funktionen in Kotlin',
        duration: '10 min',
        theory: `
<h2>Lambda Expressions ⚡</h2>
<p>Anonyme Funktionen in Kotlin. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 9,
        title: 'Klassen & OOP',
        description: 'Objektorientiertes Kotlin',
        duration: '12 min',
        theory: `
<h2>Klassen & OOP 🛡️</h2>
<p>Objektorientiertes Kotlin. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 10,
        title: 'Data Classes',
        description: 'Datenklassen für weniger Boilerplate',
        duration: '10 min',
        theory: `
<h2>Data Classes ✨</h2>
<p>Datenklassen für weniger Boilerplate. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Data Classes – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Data Classes</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        ...
        description: 'Eingeschränkte Hierarchien',
        duration: '10 min',
        theory: `
<h2>Sealed Classes 📄</h2>
<p>Eingeschränkte Hierarchien. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Sealed Classes – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Sealed Classes</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    {
        id: 12,
        title: 'Enums & Companion',
        description: 'Aufzählungen und statische Member',
        duration: '10 min',
        theory: `
<h2>Enums & Companion 🎀</h2>
<p>Aufzählungen und statische Member. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Enums & Companion – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Enums & Companion</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 13,
        title: 'Generics',
        description: 'Generische Typen in Kotlin',
        duration: '12 min',
        theory: `
<h2>Generics 🔗</h2>
<p>Generische Typen in Kotlin. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 14,
        title: 'Extensions',
        description: 'Bestehende Klassen erweitern',
        duration: '10 min',
        theory: `
<h2>Extensions 🧩</h2>
<p>Bestehende Klassen erweitern. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Extensions – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Extensions</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        ...
        description: 'let, run, apply, also, with',
        duration: '10 min',
        theory: `
<h2>Scope Functions 🎯</h2>
<p>let, run, apply, also, with. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Scope Functions – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Scope Functions</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        ...
        duration: '12 min',
        theory: `
<h2>Coroutines Basics 💡</h2>
<p>Asynchrone Programmierung. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Coroutines Basics – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Coroutines Basics</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        ...
        description: 'Flows und Channels',
        duration: '12 min',
        theory: `
<h2>Coroutines Advanced 🔒</h2>
<p>Flows und Channels. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Coroutines Advanced – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Coroutines Advanced</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 18,
        title: 'Delegation',
        description: 'by und delegates',
        duration: '10 min',
        theory: `
<h2>Delegation ⏳</h2>
<p>by und delegates. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Delegation – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Delegation</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 19,
        title: 'Destructuring',
        description: 'Werte auspacken',
        duration: '8 min',
        theory: `
<h2>Destructuring 🧮</h2>
<p>Werte auspacken. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Destructuring – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Destructuring</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        ...
        description: 'Performance mit inline',
        duration: '10 min',
        theory: `
<h2>Inline Functions 🌐</h2>
<p>Performance mit inline. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Inline Functions – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Inline Functions</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Metaprogrammierung. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Annotation Processing – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Annotation Processing</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        ...
        theory: `
<h2>Sequences 🔥</h2>
<p>Lazy Evaluation. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Sequences – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Sequences</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 23,
        title: 'Type Aliases',
        description: 'Typen umbenennen',
        duration: '8 min',
        theory: `
<h2>Type Aliases 💪</h2>
<p>Typen umbenennen. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Type Aliases – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Type Aliases</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        ...
        description: 'Eigene DSLs erstellen',
        duration: '12 min',
        theory: `
<h2>DSLs in Kotlin 🎮</h2>
<p>Eigene DSLs erstellen. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// DSLs in Kotlin – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von DSLs in Kotlin</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 25,
        title: 'Serialization',
        description: 'JSON mit kotlinx.serialization',
        duration: '10 min',
        theory: `
<h2>Serialization 📡</h2>
<p>JSON mit kotlinx.serialization. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Serialization – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Serialization</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 26,
        title: 'Ktor',
        description: 'HTTP-Client und Server',
        duration: '12 min',
        theory: `
<h2>Ktor 🗄️</h2>
<p>HTTP-Client und Server. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Ktor – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Ktor</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        ...
        description: 'Kotlin für Android',
        duration: '12 min',
        theory: `
<h2>Android Basics 📦</h2>
<p>Kotlin für Android. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Android Basics – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Android Basics</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        ...
        description: 'Deklarative Android-UI',
        duration: '12 min',
        theory: `
<h2>Jetpack Compose 🧪</h2>
<p>Deklarative Android-UI. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Jetpack Compose – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Jetpack Compose</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    },
    {
        id: 29,
        title: 'Testing',
        description: 'Tests mit JUnit und MockK',
        duration: '10 min',
        theory: `
<h2>Testing 🏃</h2>
<p>Tests mit JUnit und MockK. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>
...
<p>Übe diese Konzepte regelmäßig und baue eigene kleine Projekte damit!</p>
    ...
    {
        id: 30,
        title: 'Projekt: Android App',
        description: 'Eine Android-App bauen',
        duration: '15 min',
        theory: `
<h2>Projekt: Android App 🏆</h2>
<p>Eine Android-App bauen. In dieser Lektion lernst du die wichtigsten Konzepte und Techniken.</p>

<h3>Grundlagen</h3>
<pre class="code-block">// Projekt: Android App – Beispielcode
// Hier siehst du die Grundlagen dieses Themas</pre>

<h3>Wichtige Konzepte</h3>
<ul>
  <li>Grundlegendes Verständnis von Projekt: Android App</li>
  <li>Praktische Anwendung im Code</li>
  <li>Best Practices und häufige Fehler</li>
</ul>
